...
class DuffingConservative(object):
	...
	def all_terms(self, state: np.ndarray) -> np.ndarray:
		"""
		...
		"""
		return self.linear_term(state) + self.nonlinear_term(state)
...
print("nonlinear term ", duffing.nonlinear_term(state).shape, " = \n", duffing.nonlinear_term(state))
print("jacobian nonlinear_term ", duffing.jacobian_nonlinear_term(state).shape, " = \n", duffing.jacobian_nonlinear_term(state))
print("all terms ", duffing.all_terms(state).shape, " = \n", duffing.all_terms(state))
...
print("sequence of nonlinear terms", duffing.nonlinear_term(state_vectorized).shape, "\n", 
      np.round(duffing.nonlinear_term(state_vectorized),9))
print("sequence of jacobians of the nonlinear terms", duffing.jacobian_nonlinear_term(state_vectorized).shape, "\n", 
      np.round(duffing.jacobian_nonlinear_term(state_vectorized),9))
