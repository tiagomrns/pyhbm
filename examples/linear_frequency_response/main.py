...
if False:
    ...
    HarmonicBalanceMethod(
        first_order_ode = LinearOscillator(A, C, S, is_real_valued=True), 
        harmonics = [1], 
    ).solve_and_continue(
        maximum_number_of_solutions = 300, 
        angular_frequency_range = [0, 10], 
        solver_kwargs = {
    ...
    HarmonicBalanceMethod(
        first_order_ode = LinearOscillator(A, C, S, is_real_valued=False), 
        harmonics = [1,-1], 
    ).solve_and_continue(
        maximum_number_of_solutions = 300, 
        angular_frequency_range = [0, 10], 
